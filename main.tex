...
\input{Chapters/1_introducere}
\input{Chapters/2_baza_date}
\input{Chapters/3_arhitectura_software}
\input{Chapters/4_descrierere_algoritmi} 
\input{Chapters/5_management_erori} 
\input{Chapters/6_concluzii} 
